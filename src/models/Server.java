        ...
        public void run() {
            while (true) {
                try {
                    ...
                    if (slaves.size() == 0) {
                        ArrayList<Integer> results = new PrimeCalculator(start, end, threads).calculate();
                        ...
                        Thread masterThread = new Thread(() -> {
                            ArrayList<Integer> results = new PrimeCalculator(ranges.get(0)[0], ranges.get(0)[1], threads).calculate();
