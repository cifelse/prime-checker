...
print("Null Hypothesis (H0): TThere is no significant difference between the response times (ms) of the distributed with slave servers and the prime checker without slave servers.")
print("Alternative Hypothesis (H1): There is a significant difference between the response times (ms) of the distributed with slave servers and the prime checker without slave servers.")
